...
import { 
  Users, BookOpen, DollarSign, TrendingUp, Activity, Calendar 
} from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  const BackendAPI = "http://localhost:4000/admin"; 
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            <h1 className="text-4xl font-extrabold text-gray-900 mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">Admin Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <StatCard icon={Users} title="Total Students" value={stats.totalStudents.toLocaleString()} color="bg-blue-500" />
          <StatCard icon={Users} title="Total Instructors" value={stats.totalInstructors.toLocaleString()} color="bg-red-500" />
          <StatCard icon={BookOpen} title="Total Courses" value={stats.totalCourses} color="bg-purple-500" />
          <StatCard icon={DollarSign} title="Total Revenue" value={`$${stats.totalRevenue.toLocaleString()}`} color="bg-green-500" />
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-shadow duration-300">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={revenueData}>
                ...
                <Legend />
                <Line type="monotone" dataKey="revenue" stroke="#3b82f6" strokeWidth={3} dot={{ fill: '#3b82f6', r: 6 }} activeDot={{ r: 8 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        ...
        {/* Course Distribution */}
        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-shadow duration-300">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Course Distribution</h2>
